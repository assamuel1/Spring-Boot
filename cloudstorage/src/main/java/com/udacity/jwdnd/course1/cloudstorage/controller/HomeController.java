...
public class HomeController {
    ...
    @GetMapping("/home")
    public String homePageView(@ModelAttribute("noteModalForm") NoteModalForm noteModalForm , @ModelAttribute("credentialModalForm") CredentialModalForm credentialModalForm,  @ModelAttribute("Files") Files file, Model model, Authentication authentication) throws Exception {
